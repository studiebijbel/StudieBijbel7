...
function ConvertTextToHtml(vtext, bookAbbr, vChapter) {
	...
	vtext = vtext.replace("Jo&euml;l","Joël");
...
function sb_edit_HtmlToTextGetSpecialCharsArray() {
	...
	replaceArrayResults.push('ë');
	replaceArrayFrom.push('&#275;');
	replaceArrayResults.push('ē')
	replaceArrayFrom.push('&#257;');
	replaceArrayResults.push('ā')
	replaceArrayFrom.push('&#299;');
	replaceArrayResults.push('ī')
	replaceArrayFrom.push('&#333;');
	replaceArrayResults.push('ō')
	replaceArrayFrom.push('&#363;');
	replaceArrayResults.push('ū')
	...
	replaceArrayResults.push("\n");
	replaceArrayFrom.push('Ã¯');
	replaceArrayResults.push('ï');
	replaceArrayFrom.push('â€“Â');
	replaceArrayResults.push('-');
	replaceArrayFrom.push('Â â€“');
	replaceArrayResults.push('-');
	replaceArrayFrom.push('Ã¤');
	...
	replaceArrayFrom.push('Ã¼');
	replaceArrayResults.push('ü');
	replaceArrayFrom.push('Ã©');
	replaceArrayResults.push('é');
